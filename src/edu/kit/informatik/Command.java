...
public enum Command {
    ...
    CMD_ADD_ADMIN("add-admin ([^;]+);([^;]+);([^;]{4,8});([^;]{8,12})") {
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            if (!olympicGames.isLoggedIn()) {
                ...
                Main.textOutput(olympicGames.addAdmin(foreName, surName, userName, passWord));
            } else {
    ...
    CMD_LOGIN_ADMIN("login-admin ([^;]{4,8});([^;]{8,12})") {
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            if (!olympicGames.isLoggedIn()) {
                ...
                Main.textOutput(olympicGames.loginAdmin(userName, passWord));
            } else {
                throw new InvalidInputException("unexecutable, if an admin is logged in.");
            }
        }
    ...
    CMD_LOGOUT_ADMIN("logout-admin") {
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            Main.textOutput(olympicGames.logoutAdmin());
        }
    },
     ...
     */
    // add-sports-venue <id>;<country name>;<location>;<name>;<year of opening>;<amount of seats>
    CMD_ADD_SPORTS_VENUE("add-sports-venue (00[1-9]|0[1-9]\\d|[1-9]\\d\\d);" + "([^;]+);([^;]+);([^;]+);"
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            if (olympicGames.isLoggedIn()) {
                ...
                Main.textOutput(olympicGames.addSportsVenue(venueID, countryName, location, venueName, yearOfOpening,
                        amountOfSeats));
            } else {
    ...
    CMD_ADD_OLYMPIC_SPORT("add-olympic-sport ([^;]+);([^;]+)") {
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            if (olympicGames.isLoggedIn()) {
                ...
                Main.textOutput(olympicGames.addOlympicSport(sport, discipline));
            } else {
                throw new InvalidInputException("unexecutable, if no admin is logged in.");
            }
        }
    ...
    CMD_ADD_IOC_CODE("add-ioc-code (00[1-9]|0[1-9]\\d|[1-9]\\d\\d);([a-z]{3});([^;]+);"
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            if (olympicGames.isLoggedIn()) {
                ...
                Main.textOutput(olympicGames.addIocCode(iocID, iocCode, countryName, yearOfDetermination));
            } else {
                throw new InvalidInputException("unexecutable, if no admin is logged in.");
            }
        }
     ...
     */
    // add-athlete <id>;<forename>;<surname>;<country of origin>;<kind of sport>;<sport discipline>
     ...
     */
    // add-competition <id>;<year>;<country name>;<kind of sport>;<sport discipline>;<gold>;<silver>;<bronze>
    CMD_ADD_COMPETITION("add-competition (000[1-9]|00[1-9]\\d|0[1-9]\\d\\d|[1-9]\\d\\d\\d);"
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            if (olympicGames.isLoggedIn()) {
                ...
                Main.textOutput(olympicGames.addCompetition(athleteID, participationYear, countryName, sport,
    ...
    CMD_RESET("reset") {
        ...
        public void commandMethod(final MatchResult matcher, final OlympicGames olympicGames)
            ...
            if (olympicGames.isLoggedIn()) {
                Main.textOutput(olympicGames.reset());
            } else {
                throw new InvalidInputException("unexecutable, if no admin is logged in.");
            }
        }
     ...
     * @param olympicGames
     *            Reference to Olympic Games control.
