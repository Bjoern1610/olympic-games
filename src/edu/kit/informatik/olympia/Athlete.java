...
public class Athlete implements Comparable<Athlete> {
     ...
     * 
     * @param goldMedal
     *            Amount of received gold medals.
     */
     ...
     * 
     * @param silverMedal
     *            Amount of received silver medals.
     */
     ...
     * 
     * @param bronzeMedal
     *            Amount of received bronze medals.
     */
     ...
     * 
     * @param currentMedals
     *            Current amount of received medals of a certain sport.
     */
     ...
     * 
     * @param sport
     *            Sport from which one wants the medal table.
     ...
     * 
     * @param sport
     *            Sport from which the medal table is going to be refreshed.
     * @param sportsMedals
     *            New amount of received medals.
     */
     ...
     * 
     * @param otherSport
     *            Sport from which the athlete wants to participate.
     */
     ...
     * 
     * @param otherSport
     *            Sport which wants to be checked, if the athlete is participating or not.
     * @return True, if the athlete is already participating in this sport. False, if not.
     */
    ...
    /**
     * Inserts the year in which the athlete has competed in an Olympic Games competition.
     * 
     * @param sport
     *            Sport which the athlete has competed.
     * @param newYear
     *            Year in which the athlete has competed.
     */
    ...
    /**
     * Checks if an athlete has already competed in a year of an Olympic Games competition.
     * 
     * @param sport
     *            Sport which is checked if it has already been contested.
     * @param year
     *            Year in which the athlete might have already contested.
     * @return True, if the athlete has already competed in the given sport and year. False, if not.
     */
