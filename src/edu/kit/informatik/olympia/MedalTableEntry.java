...
public class MedalTableEntry implements Comparable<MedalTableEntry> {
    ...
    /**
     * Creates a new medal table entry for each country participating at the Olympic Games.
     * 
     * @param country
     *            Reference to a country.
     * @param totalGold
     *            Total amount of gold medals for a country.
     * @param totalSilver
     *            Total amount of silver medals for a country.
     * @param totalBronze
     *            Total amount of bronze medals for a country.
     */
     ...
     * 
     * @param totalMedals
     *            Total amount of all received medals.
     */
